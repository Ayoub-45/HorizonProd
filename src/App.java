...
public class App {
     ...
     * Product prod1 = new Product(1021, "Milk", "Delight"); // Price is not
     * initalized so It will display 0 by default
     * Product prod2 = new Product(2510, "Yogurt", "Vitalait"); // Price is not
     * initalized so It will display 0 by
     * // default
     ...
     * for (Product product : products) {
     * // display different address : Each object has been allocated to a memory
     * space
